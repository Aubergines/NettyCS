...
package xyz.zsq.example.http2.tiles;
...
public final class Launcher {
    ...
    public static void main(String[] args) {
        ...
        try {
            http2.start();
            System.err.println("Open your web browser and navigate to " + "http://" + xyz.zsq.example.http2.tiles.Html.IP + ":" + xyz.zsq.example.http2.tiles.HttpServer.PORT);
            http.start().sync();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
